#!/bin/bash
#SBATCH --job-name=sparcal_P6
#SBATCH --output=slurm_output/P6_TUMOR/sparcal_P6-%j.out
#SBATCH --error=slurm_output/P6_TUMOR/sparcal_P6-%j.err
...
echo ""; echo "All P6_TUMOR sections complete! $(date)"