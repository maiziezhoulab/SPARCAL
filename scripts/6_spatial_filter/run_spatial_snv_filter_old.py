...
TUMOR_DATASETS_DIR = "/lio/lfs/maiziezhou_lab/maiziezhou_lab/Datasets/ST_datasets/STmut_Data"
    ...
    def setup_paths(self):
        ...
        if self.dataset == "DLPFC":
            ...
            self.spatial_base_dir = os.path.join(
                config["base_path"], 
                f"spaceranger_align_rep{self.section_id}", 
...
# python scripts/6_spatial_filter/run_spatial_snv_filter.py --dataset p4_tumor --section_id 1 --quality_filter baseQ0mapQ0 --exclude_vcf /data/maiziezhou_lab/leiy4/snv_calling/data/P4_tumor/1/output_VCFs/beagle/baseQ0mapQ0/all_filtered_in.vcf.gz --min_neighbours 1 --include_vcf /lio/lfs/maiziezhou_lab/maiziezhou_lab/Datasets/ST_datasets/STmut_Data/P4_Somatic_Mutect2/P4_somatic_snp_chr1_22.vcf.gz
...
# python scripts/6_spatial/run_spatial_snv_filter.py --dataset p4_tumor --section_id 1 --quality_filter baseQ0mapQ0 --exclude_vcf /data/maiziezhou_lab/leiy4/snv_calling/data/P4_tumor/1/output_VCFs/beagle/baseQ0mapQ0/all_filtered_in.vcf.gz --include_vcf /lio/lfs/maiziezhou_lab/maiziezhou_lab/Datasets/ST_datasets/STmut_Data/P4_Somatic_Mutect2/P4_somatic_exome_snps.vcf --min_neighbours 6
# python scripts/6_spatial/run_spatial_snv_filter.py --dataset p4_tumor --section_id 1 --quality_filter baseQ0mapQ0 --exclude_vcf /data/maiziezhou_lab/leiy4/snv_calling/data/P4_tumor/1/output_VCFs/beagle/baseQ0mapQ0/all_filtered_in.vcf.gz --include_vcf /lio/lfs/maiziezhou_lab/maiziezhou_lab/Datasets/ST_datasets/STmut_Data/P4_Normal_WES/P4_Normal_WES_gatk_snp_chr1_22.vcf.gz --min_neighbours 0
