...
#SBATCH --job-name=nn_classifier_DCIS
#SBATCH --output=slurm_output/DCIS/nn_classifier_DCIS_%a.out
#SBATCH --error=slurm_output/DCIS/nn_classifier_DCIS_%a.err
...
# python /data/maiziezhou_lab/leiy4/snv_calling/scripts/4_classifier/run_sparcal_net.py --dataset DCIS --section_id ${SECTION_ID} --quality-filter ${QUALITY_FILTER}
