...
#SBATCH --job-name=final_snv_mat_DCIS2
#SBATCH --output=slurm_output/DCIS/baseQ0mapQ0/final_snv_mat_dcis2.out
#SBATCH --error=slurm_output/DCIS/baseQ0mapQ0/final_snv_mat_dcis2.err
...
SECTION_ID=dcis2   # resolves to data/dcis2/
