...
#SBATCH --job-name=upv_baf_gmm_P4
#SBATCH --output=slurm_output/P4_tumor/baseQ0mapQ0_section1/upv_baf_gmm_P4.out
#SBATCH --error=slurm_output/P4_tumor/baseQ0mapQ0_section1/upv_baf_gmm_P4.err
...
# Step 7c — UPV BAF-GMM sub-filter for P4_TUMOR (section 1).
...
mkdir -p slurm_output/P4_tumor/${QUALITY_FILTER}_section${SECTION_ID}
