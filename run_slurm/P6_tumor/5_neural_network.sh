...
#SBATCH --job-name=nn_classifier_P6_TUMOR
#SBATCH --output=slurm_output/P6_TUMOR/nn_classifier_P6_TUMOR_%a.out
#SBATCH --error=slurm_output/P6_TUMOR/nn_classifier_P6_TUMOR_%a.err
...
# python /data/maiziezhou_lab/leiy4/snv_calling/scripts/4_classifier/run_sparcal_net.py --dataset P6_TUMOR --section_id ${SECTION_ID} --quality-filter ${QUALITY_FILTER}
